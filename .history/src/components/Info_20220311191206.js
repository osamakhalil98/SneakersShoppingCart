...
export default function Info() {
  return (
    <div className="flex flex-col w-fit align-end h-auto items-end content-end mt-8 mx-auto self-end bg-green-200">
      <div className="w-3/4 mt-5">
        ...
        <div className="flex mt-6 flex-1 justify-between w-100 bg-red-200">
          <div className="w-44 bg-gray-100 flex rounded-xl align-center justify-between">
            <div className="text-center px-2 mx-1 self-center order-1">
          ...
          <div className="flex">
            <motion.button
              ...
              type="submit"
              className="sm:w-72 flex cart-btn justify-center align-center mx-auto py-3 px-6 border border-transparent shadow-xl shadow-orange-300 text-base font-bold rounded-xl text-white bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-200"
            >
