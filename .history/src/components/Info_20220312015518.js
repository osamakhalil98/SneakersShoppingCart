...
export default function Info() {
  ...
  return (
    <div className="flex flex-col w-fit align-end h-auto items-end content-end mt-8 mx-auto self-end">
      <div className="w-3/4 mt-5">
        ...
        <div className="flex mt-6 flex-1 justify-space w-100">
          <div className="w-44 bg-gray-100 flex rounded-xl align-center justify-between mr-5">
            <div
              className="text-center px-2 mx-1 self-center order-1 pale-orange-minus cursor-pointer"
              onClick={() => dispatch(decrease())}
            >
              <img className="pale-orange-minus" srcSet={iconMinus}></img>
            </div>
            <span className="text-center font-bold order-2 self-center">
              {state}
            </span>
            <div
              className="text-center hover:bg-orange-300 px-2 mx-2 self-center order-3 cursor-pointer"
