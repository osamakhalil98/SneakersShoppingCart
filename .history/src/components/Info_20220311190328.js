...
export default function Info() {
  return (
    <div className="flex flex-col w-fit mx-auto align-end items-end content-end mt-8 mx-auto self-end bg-green-200">
      <div className="mx-auto bg-indigo-200 w-84">
        <span className="text-orange-500 font-bold my-4 self-start">
          SNEAKER COMPANY
        </span>
      </div>
      <div className="w-3/4">
