      ...
      <div className="flex mt-6 flex-1 justify-between w-1/2">
        ...
        <div>
          <motion.button
            ...
            type="submit"
            className="sm:w-80 cart-btn justify-center mx-auto py-3 px-6 border border-transparent shadow-xl shadow-orange-400 text-base font-bold rounded-xl text-white bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-200"
          >
            <img srcSet={iconCart} />
            Add to cart
          </motion.button>
