...
export default function Info() {
  ...
  return (
    <div className="flex flex-col md:w-full align-end h-auto md:items-end md:content-end mt-8 md:mx-auto md:self-end info-container">
      <div className="md:w-full md:w-3/4 mt-5 info-content">
        ...
        <div>
          <p className="text-gray-400 font-medium w-full md:w-84 mb-4">
        ...
        <div className="flex mt-6 flex-1 justify-space w-100 buttons-container">
          <div className="ctrl-btns w-full md:w-44 bg-gray-100 flex rounded-xl align-center justify-between mr-5">
            <div
          ...
          <div className="flex ">
            <motion.button
              ...
              className=" w-full cart-btnn sm:w-72 flex cart-btn justify-center align-center  py-3 px-6 border border-transparent shadow-xl shadow-orange-300 text-base font-bold rounded-xl text-white bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-200"
            >
