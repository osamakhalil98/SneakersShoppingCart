...
export default function Cart() {
  ...
  return (
    <div className="rounded-2xl mx-auto w-40 md:w-80 h-52 bg-white shadow-xl">
      ...
      {state > 0 ? (
        <>
          <div className="flex mt-3 justify-between ml-2 md:mx-2">
            <img
          ...
          <motion.button
            ...
            type="submit"
            className="w-34 md:w-72 flex mx-auto mt-4 cart-btn justify-center align-center  py-3 px-6 border border-transparent  shadow-orange-300 text-base font-bold rounded-xl text-white bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-200"
          >
            Checkout
          </motion.button>
        </>
