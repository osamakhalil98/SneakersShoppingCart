  ...
  return (
    <div className="nav relative bg-white px-2 pt-2 pb-4 w-auto h-20 flex flex-row  mx-auto">
      ...
      <div className="w-3/5 ml-4">
        <ul className="flex flex-auto flex-row justify-start list-none text-gray-500 bg-red-200 h-auto">
          <li className="mx-3 h-100 item hover:border-b-4 border-b-orange-500 cursor-pointer">
            Collections
          </li>
