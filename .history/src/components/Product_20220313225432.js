...
export default function Product() {
  ...
  return (
    <div className="mt-5">
      ...
      <div id="mainProd cursor-pointer mt-5">
        <img
      ...
      <img
        ...
        onClick={handlePrev}
      ></img>
      <div className="mySlides slides hidden firstProd" img-slides="1">
        <img
          className="rounded-2xl "
          srcSet={product1}
          height={400}
      ...
      <div className="mySlides hidden slides secondProd" img-slides="2">
        <img
          className="rounded-2xl "
          srcSet={product2}
          height={400}
      ...
      <div className="mySlides hidden slides thirdProd" img-slides="3">
        <img
          className="rounded-2xl"
          srcSet={product3}
          height={400}
      ...
      <div className="mySlides hidden slides fourthProd" img-slides="4">
        <img
          className="rounded-2xl"
          srcSet={product4}
          height={400}
