      ...
      <div className="flex mt-6 flex-1 justify-between w-1/2">
        ...
        <div>
          <motion.button
            ...
            type="submit"
            className="sm:w-80 justify-center mx-auto py-3 px-6 border border-transparent shadow-sm text-base font-bold rounded-xl text-white bg-orange-400 hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-300"
          >
            <img srcSet={iconCart} />
            Add to cart
          </motion.button>
