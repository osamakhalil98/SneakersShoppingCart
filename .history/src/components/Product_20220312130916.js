      ...
      <div id="myModal" className="modal mx-auto hidden">
        <div className="modal-content mx-auto">
          ...
          <img
            ...
            onClick={handlePrev}
          ></img>
          <div className="mySlides slides firstProd " img-slides>
            <img
          ...
          <div className="mySlides slides secondProd" img-slides>
            <img
              className="rounded-2xl "
              srcSet={product2}
              height={500}
          ...
          <div className="mySlides slides thirdProd" img-slides>
            <img
              className="rounded-2xl"
              srcSet={product3}
              height={500}
          ...
          <div className="mySlides slides fourthProd" img-slides>
            <img
              className="rounded-2xl"
              srcSet={product4}
              height={500}
