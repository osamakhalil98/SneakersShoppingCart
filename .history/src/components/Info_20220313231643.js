        ...
        <div className="flex mt-6 flex-1 justify-space w-100 buttons-container">
          ...
          <div className="flex ">
            <motion.button
              ...
              className=" w-full sm:w-72 flex cart-btn justify-center align-center  py-3 px-6 border border-transparent shadow-xl shadow-orange-300 text-base font-bold rounded-xl text-white bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-200"
            >
