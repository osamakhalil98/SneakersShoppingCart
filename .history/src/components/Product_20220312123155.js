        ...
        <div id="myModal" className="modal mx-auto">
          <div className="modal-content mx-auto">
            ...
            <img
              ...
              onClick={() => setLightBoxStatus(!lightBoxStatus)}
            ></img>
            <div className="mySlides slides firstProd none">
              <img
            ...
            <div className="mySlides slides secondProd none">
              <img
                className="rounded-2xl "
                srcSet={product2}
                height={500}
            ...
            <div className="mySlides slides thirdProd none">
              <img
                className="rounded-2xl"
                srcSet={product3}
                height={500}
            ...
            <div className="mySlides slides fourthProd none">
              <img
                className="rounded-2xl"
                srcSet={product4}
                height={500}
