...
export default function Info() {
  return (
    <div className="flex flex-col mx-auto align-end items-end content-end mt-8 mx-auto self-end bg-green-200">
      <span className="text-orange-500 font-bold my-4 self-baseline">
        SNEAKER COMPANY
      </span>
      <div className="w-3/4">
