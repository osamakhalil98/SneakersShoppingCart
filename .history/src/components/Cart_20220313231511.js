      ...
      {state > 0 ? (
        <>
          ...
          <motion.button
            ...
            type="submit"
            className="w-34 md:w-72 flex mx-auto mt-2 md:mt-4 cart-btn justify-center align-center  py-1 md:py-3 px-6 border border-transparent  shadow-orange-300 text-base font-bold rounded-xl text-white bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-200"
          >
            Checkout
          </motion.button>
        </>
