...
export default function Info() {
  ...
  return (
    <div className="flex flex-col w-full align-end h-auto items-end content-end mt-8 mx-auto md:self-end info-container">
      <div className="w-full md:w-3/4 mt-5 info-content">
        <span className="text-orange-500 font-bold my-6 self-start ">
          SNEAKER COMPANY
        </span>
        <h1 className="text-5xl font-extrabold text-stone-900 mb-8 mt-6 w-full">
