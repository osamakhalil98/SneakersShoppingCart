...
export default function Nav() {
  ...
  return (
    <div className="nav relative hidden px-2 pt-2 md:w-auto h-20 flex flex-row bg-red-200 mx-auto">
      <div className="mr-4 logo">
        <img srcSet={logo} className="h-100 w-auto"></img>
      </div>
      <div className="w-3/5 ml-4 h-full hidden">
