...
export default function Product() {
  ...
  const handleNext = () => {
    // checking the viewport size
    if (window.matchMedia("(max-width:375px)").matches) {
      const allSlides = document.querySelectorAll("[img-swipe]");
      ...
      if (idx === 3) {
        ...
        slides[idx + 1].classList.remove("hidden");
      }
      return;
    } else {
  ...
  return (
    <div className="mt-5">
      ...
      <div id="mainProd cursor-pointer mt-5" img-swipe="1">
        <img
      ...
      <div className="mySlides hidden slides secondProd" img-swipe="2">
        <img
      ...
      <div className="mySlides hidden slides thirdProd" img-swipe="3">
        <img
          className="md:rounded-2xl"
          srcSet={product3}
          height={400}
      ...
      <div className="mySlides hidden slides fourthProd" img-swipe="4">
        <img
          className="md:rounded-2xl"
          srcSet={product4}
          height={400}
      ...
      <div
        className="hidden md:flex mt-5 flex-row justify-between"
        ref={currentProduct}
      >
